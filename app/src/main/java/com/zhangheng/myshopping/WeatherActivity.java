...
import com.zhangheng.myshopping.adapter.WeatherList_Adapter;
...
public class WeatherActivity extends Activity implements View.OnClickListener {
    ...
    private ImageView m7_weather_iv_back;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        m7_weather_iv_back=findViewById(R.id.m7_weather_iv_back);
        m7_weather_iv_back.setOnClickListener(this);
        if (address.endsWith("市")){
            m7_et_city.setText(address.substring(0,address.length()-1));
        }else {
            m7_et_city.setText(address);
        }
        getRealWeather(m7_et_city.getText().toString());
    }
