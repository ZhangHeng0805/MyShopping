package com.zhangheng.myshopping.view;
...
public class RefreshListView extends ListView implements AbsListView.OnScrollListener {
    ...
    private void initFooterView() {
        mFooterView = View.inflate(getContext(), R.layout.layout_header_refreshlist, null);
...
// 向下转, 围绕着自己的中心, 逆时针旋转 -180 -> -360
    ...
    private void initHeaderView() {
        mHeaderView = View.inflate(getContext(), R.layout.layout_header_refreshlist, null);
